...
st.title("📧 Generador de Emails de Facturación MELI")
...
def generate_email(consultant_name, projects_data, month):
    ...
    if is_english:
        ...
        subject = f"MELI - Fees {month_en} 2025 {first_name}"
        ...
        email += "Please remember:\n- Upload your invoice to AFN Support form\n- Include the project codes in your invoice\n\nBest regards!"
        
    else:
        subject = f"MELI - Fees {month.lower()} 2025 {first_name}"
    ...
    try:
        ...
        if len(afnm_data) > 0:
            ...
            for consultant_name, projects in consultants.items():
                email = generate_email(consultant_name, projects, month)
